  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="Pages/AdminLogin.1.php"><span class="glyphicon glyphicon-log-in"></span> Admin Login</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div class="container-fluid text-center"> 
  <div class="row content">
    ...
    <div class="col-sm-8 text-center" style="font-size: 40px"><br> 
 
      <h1>Mr Ticket</h1>
      <p>Enter your email to get started</p>

      <form action="Pages/CheckLogin.1.php" method="POST">
    <input type="text" style="font-size:20px; text-align:center;"  name="email" size=75px placeholder="example@scslakeview-k12.com"/><br>
  <br>
